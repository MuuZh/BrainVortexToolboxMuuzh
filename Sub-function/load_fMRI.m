...
%         dataIn = dataOut(1:175,1:251,1midPoint(1),midPoint(2),midPoint(3)) ;
%
...
if flagSur == 1
    if flagRest == 0 && flagTask == 1  % task data
        dataIn = dataOut(1:175,1:251,1:315); % ensure odd number
    elseif flagTask == 4 % rest data
        % dataIn = dataOut(1:175,1:251,1:283); % ensure odd number
        dataIn = dataOut(1:175,1:251,1:217); % 217 for LDS data
    elseif flagRest == 1 % rest data
        dataIn = dataOut(1:175,1:251,1:1199);
    elseif flagTask == 5 % LSD data
        dataIn
    end
